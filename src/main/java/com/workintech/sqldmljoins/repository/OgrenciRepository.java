...
public interface OgrenciRepository extends JpaRepository<Ogrenci, Long> {
    ...
    String QUESTION_2 =
            "SELECT o.* FROM ogrenci o, islem i WHERE o.ogrno = i.ogrno";
    ...
    String QUESTION_4 =
            "SELECT o.sinif, COUNT(*) AS count " +
                    "FROM ogrenci o JOIN islem i ON o.ogrno = i.ogrno " +
    ...
    String QUESTION_9 =
            "SELECT o.ad, o.soyad, COUNT(*) AS count " +
            "FROM ogrenci o JOIN islem i ON o.ogrno = i.ogrno " +
            "GROUP BY o.ogrno, o.ad, o.soyad " +
            "ORDER BY count DESC, o.ad";
